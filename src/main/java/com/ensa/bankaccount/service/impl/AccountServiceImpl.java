...
public class AccountServiceImpl implements AccountService {
    ...
    public void deposit(BalanceAccountRequest balanceAccountRequest) {
        Account account = accountRepository.findAccountByCustomerUsername(balanceAccountRequest.getUsername()).orElseThrow(()->new RuntimeException("Account Not Found"));
    ...
    public void withdraw(BalanceAccountRequest balanceAccountRequest) {
        ...
        else account.setBalance(account.getBalance()- balanceAccountRequest.getAmount());
        accountRepository.save(account);
    }
